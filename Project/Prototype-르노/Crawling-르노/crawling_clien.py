...
def per_post_crawling(driver):
    ...
    return content, like_cnt, view_cnt, cmt_authors, cmt_contents, cmt_post_ids, cmt_cnt, post_id
...
if __name__=="__main__":
    ...
    output_dir='/Users/admin/Desktop/HMG/ws/Project/Crawling/output/'
    ...
    while not end:
        ...
        for post_idx in range(len(titles)):
            ...
            content, like_cnt, view_cnt, cmt_authors, cmt_contents, cmt_post_ids, cmt_cnt, post_id = per_post_crawling(driver)

            # Save to comments.csv
            ids = make_dummy_data(cmt_cnt)
            comment_data = {"id": ids,"post_id": cmt_post_ids, "content": cmt_contents, "author": cmt_authors}
        ...
        updated_ats = make_dummy_data(len(created_ats))
        post_data = {"id": post_ids, "created_at": created_ats, "updated_at": updated_ats,"title": titles, \
            'content': contents, 'likes': likes, 'url': urls, 'author': authors, 'views': views}
